...
import RecentActivity from "../../CompreSearch/RecentActivity";
...
`;
export default class IndustryTrends extends Component {
	constructor(props) {
		super(props);
		// console.log(props)
		this.state = {
