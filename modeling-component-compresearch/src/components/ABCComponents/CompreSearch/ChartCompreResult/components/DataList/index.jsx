...
// import ask from 'axios';
import ask from '../../../../../../lib/ask';
import { getQueryString } from '../../../../../../lib/lib';
import ChartCard from './../../../General/DataChart';
...
// import MOCK_DATA from '../../mock/current.json';
...
class DataSearchResults extends Component {
    ...
    loadData(reload) {
        ...
        //         selected
        //     },
        ask('ChartsInfo', { params: {
            keyword: keyword,
            limit: pageSize,
            page: 'comprehensive_chart_search' ,
            prior: order,
            input_from: 'direct',
            offset: 20 * curPage,
            selected,
