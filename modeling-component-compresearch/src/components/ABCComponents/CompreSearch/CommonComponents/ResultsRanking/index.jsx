...
@withRouter
class ResultsRanking extends React.Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        let {total, filters} = this.props;
        let [first = {}] = filters;
        return (
            <div className='compre-filter-tool clearfix'>
              <div className="rank-count fl">为您找到相关结果约
                <strong> {total} </strong>个结果
              </div>
              {
                filters.length ? <div className="rank-priority fl">
