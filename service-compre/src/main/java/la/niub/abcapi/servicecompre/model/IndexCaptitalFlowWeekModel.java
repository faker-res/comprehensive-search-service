...
public class IndexCaptitalFlowWeekModel implements Serializable {
    private Long id;
    ...
    public IndexCaptitalFlowWeekModel() {
        super();
    }
