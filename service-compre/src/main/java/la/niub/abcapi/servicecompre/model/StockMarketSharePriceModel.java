...
public class StockMarketSharePriceModel implements Serializable {
    private Long id;
    ...
    public StockMarketSharePriceModel(Long id, String stock_code, Date time, BigDecimal close_price, BigDecimal open, BigDecimal high, BigDecimal low, BigDecimal differ, BigDecimal differ_range, BigDecimal pre_close, Date update_time) {
        this.id = id;
    ...
    public StockMarketSharePriceModel() {
        super();
    }
