...
public class StockMarket1MinPriceModel implements Serializable {
    private Long id;
    ...
    public StockMarket1MinPriceModel() {
        super();
    }
