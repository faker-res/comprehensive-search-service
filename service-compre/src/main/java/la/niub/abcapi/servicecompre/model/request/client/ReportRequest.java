...
public class ReportRequest extends Request {
    ...
    public String getSubscribed_keyword() {
        return StringUtils.defaultIfBlank(subscribed_keyword, null);
    }
    ...
    public boolean isOnly_subscribed_stock() {
        return StringUtils.equalsIgnoreCase("true", only_subscribed_stock);
    }
    ...
    public boolean isOnly_subscribed_keyword() {
        return StringUtils.isNotBlank(only_subscribed_keyword);
    }
