...
public class SecPrice5MinModel implements Serializable {
    private Long id;
    ...
    public SecPrice5MinModel(Long id, Long sec_uni_code, String sec_code, Date trade_date, BigDecimal open, BigDecimal high, BigDecimal low, BigDecimal close_price, BigDecimal differ, BigDecimal differ_range, BigDecimal volume, BigDecimal amount, BigDecimal turn, BigDecimal amplitude, Date update_time) {
        this.id = id;
