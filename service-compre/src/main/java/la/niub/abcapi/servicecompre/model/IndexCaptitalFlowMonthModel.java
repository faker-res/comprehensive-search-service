...
public class IndexCaptitalFlowMonthModel implements Serializable {
    private Long id;
    ...
    public IndexCaptitalFlowMonthModel() {
        super();
    }
