...
public class SecPriceMonthModel implements Serializable {
    private Integer id;
    ...
    private BigDecimal pre_close_month;
    ...
    public SecPriceMonthModel(Integer id, Long sec_uni_code, Date end_date, Date time, BigDecimal close_price, BigDecimal open, BigDecimal high, BigDecimal low, BigDecimal pre_close_month, BigDecimal differ, BigDecimal differ_range, BigDecimal turn, BigDecimal volume, BigDecimal t_num, BigDecimal amount, BigDecimal amplitude, Date createtime, Date updatetime, String status, String remark, String creator, String editor, String come_source) {
        this.id = id;
        ...
        this.high = high;
        this.low = low;
        this.pre_close_month = pre_close_month;
        this.differ = differ;
    ...
    public BigDecimal getPre_close_month() {
        return pre_close_month;
    }

    public void setPre_close_month(BigDecimal pre_close_month) {
        this.pre_close_month = pre_close_month;
    }
    ...
    public String toString() {
        ...
        sb.append(", pre_close_month=").append(pre_close_month);
