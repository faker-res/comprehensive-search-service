...
public class Company1MinPriceModel implements Serializable {
    private Long id;
    ...
    public Company1MinPriceModel(Long id, String stock_code, Date time, BigDecimal close_price, BigDecimal open, BigDecimal high, BigDecimal low, BigDecimal differ, BigDecimal differ_range, BigDecimal volume, BigDecimal amount, BigDecimal turnover_rate, Date update_time) {
        this.id = id;
