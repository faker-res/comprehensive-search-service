...
public class StockMarketWeekPriceModel implements Serializable {
    private Long id;
    ...
    public StockMarketWeekPriceModel(Long id, String stock_code, Date time, BigDecimal close_price, BigDecimal open, BigDecimal high, BigDecimal low, BigDecimal differ, BigDecimal pre_close, BigDecimal differ_range, Date update_time) {
        this.id = id;
    ...
    public StockMarketWeekPriceModel() {
        super();
    }
