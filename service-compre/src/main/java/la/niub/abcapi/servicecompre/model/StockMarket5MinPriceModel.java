...
public class StockMarket5MinPriceModel implements Serializable {
    private Long id;
    ...
    public StockMarket5MinPriceModel(Long id, String stock_code, Date time, BigDecimal close_price, BigDecimal open, BigDecimal high, BigDecimal low, BigDecimal differ, BigDecimal differ_range, BigDecimal volume, BigDecimal amount, BigDecimal turnover_rate, Date update_time, BigDecimal now_hand, BigDecimal now_amount, BigDecimal average, BigDecimal amplitude) {
        this.id = id;
    ...
    public StockMarket5MinPriceModel() {
        super();
    }
