...
public class SecPriceYearModel implements Serializable {
    private Integer id;
    ...
    private BigDecimal pre_close_year;
    ...
    public SecPriceYearModel(Integer id, Long sec_uni_code, Date end_date, Date time, BigDecimal close_price, BigDecimal open, BigDecimal high, BigDecimal low, BigDecimal pre_close_year, BigDecimal differ, BigDecimal differ_range, BigDecimal turn, BigDecimal volume, BigDecimal t_num, BigDecimal amount, BigDecimal amplitude, Date createtime, Date updatetime, Byte status, String remark, String creator, String editor, String come_source, Byte push_search, Byte push_product) {
        this.id = id;
        ...
        this.high = high;
        this.low = low;
        this.pre_close_year = pre_close_year;
        this.differ = differ;
    ...
    public BigDecimal getPre_close_year() {
        return pre_close_year;
    }

    public void setPre_close_year(BigDecimal pre_close_year) {
        this.pre_close_year = pre_close_year;
    }
    ...
    public String toString() {
        ...
        sb.append(", pre_close_year=").append(pre_close_year);
